...
export default function BlockWithdrawalModal({
  isOpen,
  setIsOpen,
  user,
  blockWithdrawal,
  ...
  return (
    <Modal isOpen={isOpen} setIsOpen={setIsOpen}>
      <main>
        <h2 className="text-md text-lg text-black">Block Withdrawals</h2>
        <div>
          ...
          <p className="text-md px-8 text-center text-black">
            Are you sure you sure you want to block this user withdrawals on
            palremit
          </p>
