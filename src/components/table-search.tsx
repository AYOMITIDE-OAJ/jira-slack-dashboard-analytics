...
export default function TableSearch({
  ...
  return (
    <div className="flex items-center rounded-lg border border-neutral-300 px-2">
      ...
      <input
        ...
        onChange={onChange}
        className="w-64 flex-1 rounded-sm border-0 bg-transparent py-3 font-light ring-0 focus:outline-none"
      />
    </div>
  )
}
