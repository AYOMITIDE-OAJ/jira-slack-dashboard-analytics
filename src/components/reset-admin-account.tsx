...
interface Props {
  ...
  user: any
  resetUserCredential: (id: string) => Promise<void>
}

export default function ResetAdminModal({
  isOpen,
  setIsOpen,
  user,
  resetUserCredential,
  ...
  const handleSaveChanges = () => {
    setIsOpen(false)
    resetUserCredential(user._id)
  }
  return (
    <Modal isOpen={isOpen} setIsOpen={setIsOpen}>
      <main>
        <h2 className="text-md text-lg text-black">Reset User Account</h2>
        <div>
          ...
          <p className="text-md px-8 text-center text-black">
            Are you sure you sure you want to reset this user login credential
          </p>
