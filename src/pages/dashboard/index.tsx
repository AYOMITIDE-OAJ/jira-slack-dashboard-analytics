...
import { isCustomRole, isSuperAdmin, Roles } from '@/lib/roles'
...
const Dashboard = () => {
  ...
  return (
    <Layout header="Dashboard" loading={loading}>
      ...
      {isCustomRole(userSession?.role, [Roles.Investor]) && (
        <div className="col-span-1 grid grid-cols-1 gap-4 md:col-span-3 md:grid-cols-2">
          <CardLayout className="px-8 py-20">
            <div className="flex h-full w-full items-center space-x-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg border border-neutral-200">
                <svg
                  width="30"
          ...
          <CardLayout className="px-8 py-16">
            <div className="flex h-full w-full items-center space-x-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg border border-neutral-200">
                <svg
                  width="26"
          ...
          <CardLayout className="px-0 py-16">
            <div className="space-y-4">
              <div className="px-5">
              ...
              <div className="grid grid-cols-1 gap-3 divide-x divide-gray-200 md:grid-cols-2">
                <div className="space-y px-5">
                  <p className="text-xs md:text-base">PROFIT</p>
                  <p className="text-lg font-semibold text-green-600 md:text-2xl">
                    {`$ ${thousandSeparator(22000.54)}`}
                  </p>
                  <p className="flex items-start text-xs font-light md:text-base">
                    <span className="text-base">
                      <RiArrowUpSFill className="text-green-600" />
                    </span>{' '}
                    <span className="text-gray-400">25% since last month</span>
                ...
                <div className="space-y px-5">
                  <p className="text-xs md:text-base">LOSS</p>
                  <p className="text-lg font-semibold text-red-500 md:text-2xl">
                    {`-$ ${thousandSeparator(220.26)}`}
                  </p>
                  {/* <p className="flex items-start text-xs font-light">
                    <span className="text-base">
      ...
      {isCustomRole(userSession?.role, [Roles.Marketer]) && (
        <div className="col-span-1 grid grid-cols-1 gap-4 md:col-span-3 md:grid-cols-2">
          <CardLayout className="px-8 py-20">
            <div className="flex h-full w-full items-center space-x-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg border border-neutral-200">
